...
```{r}
t.test(full.itn.irs.dat$Pre.Measure.Case.Mean, full.itn.irs.dat$Post.Measure.Case.Mean, paired = TRUE, alternative = "two.sided")
t.test(full.itn.dat$Pre.Measure.Case.Mean, full.itn.dat$Post.Measure.Case.Mean, paired = TRUE, alternative = "two.sided")
```
